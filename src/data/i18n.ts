...
const PT: Dict = {
  ...
  // Plugins
  plugin_snake:   'Jogo da Cobrinha',
  plugin_stats:   'Estatísticas GitHub',
  plugin_streak:  'Sequência de Commits',
  plugin_langs:   'Linguagens Principais',
  plugin_trophy:  'Troféus',
  plugin_graph:   'Gráfico de Atividade',
  plugin_views:   'Contador de Visitantes',
  plugin_waka:    'WakaTime',
  plugin_spotify: 'Spotify Tocando Agora',
  plugin_leet:    'Estatísticas LeetCode',
  plugin_cw:      'Estatísticas Codewars',
  plugin_hr:      'HackerRank',
  plugin_wave:    'Cabeçalho/Ondas',
